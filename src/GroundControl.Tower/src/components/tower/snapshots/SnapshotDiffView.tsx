  ...
  return (
    <div className="grid gap-3">
      <div className="grid gap-3 md:grid-cols-2">
        <div className="rounded-lg bg-bg-container px-3 py-2 font-mono text-[11.5px] text-fg-caption">Active</div>
        <div className="rounded-lg bg-bg-container px-3 py-2 font-mono text-[11.5px] text-fg-caption">This snapshot</div>
      </div>
      <JsonDiff after={snapshotToDocument(snapshot)} before={snapshotToDocument(activeSnapshot)} className="min-h-[520px] border border-stroke-subtle bg-bg-container" mode="split" />
    </div>
  );
}