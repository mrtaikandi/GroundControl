...
internal sealed class UpdateUserCommand : Command<UpdateUserHandler, UpdateUserOptions>
{
        ...
        : base("update", "Update a user")
    {
        ...
        var usernameOption = new Option<string?>("--username", "The new username");
        var emailOption = new Option<string?>("--email", "The new email address");
        var isActiveOption = new Option<bool?>("--active", "Whether the user is active");
