...
internal sealed class DeleteGroupHandler : ICommandHandler
{
    ...
    public async Task<int> HandleAsync(CancellationToken cancellationToken)
    {
        ...
        GroupResponse? current = null;

        if (version is null)
        {
            try
            {
                current = await _client.GetGroupHandlerAsync(_options.Id, cancellationToken);
        ...
        try
        {
            ...
            await _client.DeleteGroupHandlerAsync(_options.Id, cancellationToken);
